...
#endif
{
	...
	for (const auto& TexutreResource : NativeTextures)
	{
		...
		if (static_cast<int32>(TargetableTextureFlags) & static_cast<int32>(TexCreate_RenderTargetable))
		{
...
#if ENGINE_MINOR_VERSION > 25||ENGINE_MAJOR_VERSION>4
		else if (static_cast<int32>(TargetableTextureFlags) & static_cast<int32>(TexCreate_Foveation))
		{
