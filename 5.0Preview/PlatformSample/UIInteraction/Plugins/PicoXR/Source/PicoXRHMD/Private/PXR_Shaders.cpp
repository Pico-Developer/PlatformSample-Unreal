...
IMPLEMENT_SHADER_TYPE(, FMRCPSMipLevel, TEXT("/Plugin/PicoXR/Private/PicoShaders.usf"), TEXT("MainMipLevelUE5"), SF_Pixel);
IMPLEMENT_SHADER_TYPE(, FMRCPSsRGBSourceMipLevel, TEXT("/Plugin/PicoXR/Private/PicoShaders.usf"), TEXT("MainsRGBSourceMipLevelUE5"), SF_Pixel);
#else
