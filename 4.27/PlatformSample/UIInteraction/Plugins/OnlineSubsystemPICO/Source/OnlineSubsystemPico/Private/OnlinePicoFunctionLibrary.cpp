...
#endif
        if (!PicoSubsystemManager || PicoSubsystemManager->GetOuter() != WorldContextObject->GetWorld())
        {
            PicoSubsystemManager = NewObject<UOnlineSubsystemPicoManager>(WorldContextObject->GetWorld());
        }
        return PicoSubsystemManager;
    }
    return nullptr;
