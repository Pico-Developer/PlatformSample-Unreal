...
void FPicoXRDPInput::ProcessButtonEvent()
{
	...
	if (LeftConnectState)
	{
		...
		float Y=0;
		//AxisValue
		PicoXRHMD->CurrentDirectPreview->GetControllerAxisValue(0,X,Y, LeftControllerTriggerValue, LeftControllerGripValue);
		LeftControllerTouchPoint.X=X;
		LeftControllerTouchPoint.Y=Y;
		//Trigger Grip Button
	...
	if (RightConnectState)
	{
		...
		float Y=0;
		//AxisValue
		PicoXRHMD->CurrentDirectPreview->GetControllerAxisValue(0,X,Y, RightControllerTriggerValue, RightControllerGripValue);
		RightControllerTouchPoint.X=X;
		RightControllerTouchPoint.Y=Y;
